...
class OpMerge extends AbstractOp_1.AbstractOp {
    ...
    merge(one, two) {
        ...
        if ((0, util_1.isTextNode)(one) && (0, util_1.isTextNode)(two))
            return Object.assign(Object.assign(Object.assign({}, one), two), { text: one.text + two.text });
        if ((0, util_1.isElementNode)(one) && (0, util_1.isElementNode)(two))
            return Object.assign(Object.assign(Object.assign({}, one), two), { children: [...one.children, ...two.children] });
        return [one, two];
    }
    toJson(parent) {
        const op = {
