...
const update = ({ t, services }) => (r) => {
    ...
    return r.prop('presence.update', Func, ({ room, id, data }) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const entry = (yield services.presence.update(room, id, ttl * 1000, data));
        return {
            entry,
            time: Date.now(),
        };
