...
class RpcPersistentClient {
    constructor(params) {
        ...
        const ping = (_a = params.ping) !== null && _a !== void 0 ? _a : 15000;
        ...
        this.channel.open$.pipe((0, operators_1.filter)((open) => open)).subscribe(() => {
            ...
            const client = new StreamingRpcClient_1.StreamingRpcClient(Object.assign(Object.assign({}, (params.client || {})), { send: (messages) => {
