...
const edit = ({ t, services }) => (r) => {
    ...
    return r.prop('blocks.edit', Func, ({ id, patches }) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const res = yield services.blocks.edit(id, patches);
        return {
            patches: res.patches,
        };
    }));
