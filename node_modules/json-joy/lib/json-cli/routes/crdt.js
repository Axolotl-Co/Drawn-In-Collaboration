...
const defineCrdtRoutes = (r) => r.prop('crdt.create', (t) => t
...
}), ({ value, sid, serverClock, codec }) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    codec !== null && codec !== void 0 ? codec : (codec = 'binary');
    let doc = null;
    switch (codec) {
        case 'binary': {
            doc = model.toBinary();
