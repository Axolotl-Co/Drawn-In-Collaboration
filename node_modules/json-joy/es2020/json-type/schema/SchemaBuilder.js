...
class SchemaBuilder {
    ...
    Array(a, b, c) {
        if (typeof a === 'string')
            return this.Array(b, { id: a, ...(c || {}) });
        return { __t: 'arr', ...b, type: a };
    }
    Const(value, options) {
        return { __t: 'const', value: value, ...options };
    }
    Tuple(...types) {
    ...
    Object(...args) {
        ...
        if (args.length === 1 &&
            ...
            return { __t: 'obj', ...first };
        if (args.length >= 1 && args[0] instanceof Array)
            return this.Object({ fields: args[0], ...args[1] });
