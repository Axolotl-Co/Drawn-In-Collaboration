...
export class RespEncoderLegacy extends RespEncoder {
    writeAny(value) {
        switch (typeof value) {
            case 'number':
            ...
            case 'object': {
                ...
                if (value instanceof JsonPackExtension) {
                    if (value instanceof RespPush)
                        return this.writeArr(value.val);
                    if (value instanceof RespVerbatimString)
                        return this.writeStr(value.val);
                    if (value instanceof RespAttributes)
