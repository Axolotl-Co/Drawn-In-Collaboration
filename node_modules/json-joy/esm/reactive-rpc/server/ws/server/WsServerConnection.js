...
import { WsCloseFrame, WsFrameDecoder, WsFrameHeader, WsPingFrame, WsPongFrame } from '../codec';
...
export class WsServerConnection {
    ...
    _fragments = [];
    _fragmentsSize = 0;
    defaultOnFragment = (isLast, data, isUtf8) => {
    ...
    onmessage = () => { };
    onfragment = this.defaultOnFragment;
    onping = this.defaultOnPing;
    onpong = () => { };
    onclose = () => { };
